...
abstract class ServiceNotification {
	...
	private static class PreEclair extends ServiceNotification {
		 ...
		 *
		 * from https://gist.github.com/857686
		 */
		public void setForeground(Context ctx, boolean foreground) {
			try {
				ctx.getClass().getMethod("setForeground", boolean.class).invoke(this, foreground);
			} catch (Exception e) {
				// Too bad!
			}
		}
