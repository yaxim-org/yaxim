...
import org.yaxim.bruno.chat.XMPPChatServiceAdapter;
import org.yaxim.bruno.data.ChatHelper;
import org.yaxim.bruno.data.ChatProvider;
import org.yaxim.bruno.data.ChatProvider.ChatConstants;
...
import org.yaxim.bruno.IXMPPRosterCallback.Stub;
...
public class MainWindow extends SherlockExpandableListActivity {
	...
	private void startChatActivity(String user, String userName, String message) {
		Intent chatIntent = new Intent(this,
				org.yaxim.bruno.chat.ChatWindow.class);
		if (ChatRoomHelper.isRoom(this, user))
			chatIntent.setClass(this, MUCChatWindow.class);
		Uri userNameUri = Uri.parse(user);
		chatIntent.setData(userNameUri);
		chatIntent.putExtra(org.yaxim.bruno.chat.ChatWindow.INTENT_EXTRA_USERNAME, userName);
		if (message != null) {
			chatIntent.putExtra(org.yaxim.bruno.chat.ChatWindow.INTENT_EXTRA_MESSAGE, message);
		}
	...
	private void registerXMPPService() {
		...
		xmppServiceIntent.setAction("org.yaxim.bruno.XMPPSERVICE");
